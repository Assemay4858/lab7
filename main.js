function load () {
let a=document.getElementById ("initial")
a.classList.add("wolrd");
console.log (a.classList)
a.classList.remove ("world");
console.log (a.classList)
document.getElementById("initial").remove()

console.log (document);
let hI=document.createElement ("h1");
hI.innerHTML= "Lab7 Assignment";
...
hr=document.createElement ("hr")
document.body.appendChild(hr); 
let hIII=document.createElement ("h2");
hIII.innerHTML= "Submission";
hIII.setAttribute ("style", "color:red")
document.body.appendChild(hIII)
